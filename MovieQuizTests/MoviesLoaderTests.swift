...
class MoviesLoaderTests: XCTestCase {
    ...
    func testSuccessLoading() throws {
        // Given
        let stubNetworkClient = StubNetworkClient(eluminateError: false) // говорим, что не хотим эмулировать ошибку
        ...
        loader.loadMovies { result in
            ...
            case .success(let movies):
                // проверяем что пришло, например, два фильма — ведь в тестовых данных их всего два
    ...
    func testFailureLoading() throws {
        // Given
        let stubNetworkClient = StubNetworkClient(eluminateError: true)
        let loader = MoviesLoader(networkClient: stubNetworkClient)
    ...
    struct StubNetworkClient : NetworkRouting {
        ...
        let eluminateError: Bool // этот параметр нужен, чтобы заглушка эмулировала либо ошибку сети, либо успешный ответ
